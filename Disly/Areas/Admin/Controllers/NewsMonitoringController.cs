...
{
    public class NewsMonitoringController : CoreController
    {
        ...
        // GET: Admin/NewsMonitoring
        public ActionResult Index()
        {
            var mFilter = FilterParams.Extend<MaterialFilter>(filter);
            model.List = _cmsRepository.getAllMaterials(mFilter);
            ...
            #region Group filter
            var alias = "group";
            var groupLink = "/admin/newsmonitoring/";
