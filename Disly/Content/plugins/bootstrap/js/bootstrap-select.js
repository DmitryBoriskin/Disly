...
(function ($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function () {
            ...
            if (this.options.required = (this.$element.attr('required') === null) ? Selectpicker.DEFAULTS.required : this.$element.attr('required')) {
        ...
        if (!that.isDisabled() && !$this.parent().hasClass('disabled')) {
          ...
          if (triggerChange) {
            if ((prevValue != that.$element.val() && that.multiple) || (prevIndex != that.$element.prop('selectedIndex') && !that.multiple)) {
              ...
              that.$element.parents('.form-group.invalid').removeClass('invalid');
...
//>>>>>>> f21a1163df8f9a44878fddbeba1fc9a4de8122d6
