...
;( function ( window, document, $, undefined ) {
	...
	$.swipebox = function( elem, options ) {
		...
		var ui,
			defaults = {
				useCSS : true, // false - использовать jQuery для анимации
				useSVG : true,
					...
					<div id="swipebox-container">\
						...
						<div id="swipebox-bottom-bar">\
							<div id="swipebox-arrows">\
                                ...
                                <a id="swipebox-original" target="_blank"></a>\
		...
		ui = {
			...
			setTitle : function ( index ) {
			    ...
			    //костыль
				var _url = null;
				$('#swipebox-original').empty();


				if (elements[index] !== undefined) {
				    //_url = elements[index].href;
				    var obj = $('.gallery__list .swip_wr')[index];
				    _url = $(obj).find('a').attr('data-original');
				}
				if (_url) {
				    $('#swipebox-original').show();
				    $('#swipebox-original').attr("href", _url)
				}
				else {
				    $('#swipebox-original').hide();
				}
			},
