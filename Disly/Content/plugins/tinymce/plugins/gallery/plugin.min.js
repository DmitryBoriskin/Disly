tinymce.PluginManager.add('gallery', function (editor, url) {
    ...
    var _url = "/admin/photoalbums/photolistapi";
    var _size = 30;
    var _page = 1;
    var items = [];
    var no_photo = '/Content/img/nophoto.jpg';
    ...
    function Otrisovka(params) {
        ...
        $.ajax({
            ...
            .always(function (response) {
                if (_page > 1 && response.Pager.PageCount>1) {
                    //кнопка предыдущий
                    items.push({
                        type: 'button',
                ...
                if (_page < response.Pager.PageCount) {
                    //кнопка следующий
                    items.push({
                        type: 'button',
                        title: 'Следующая страница >',
                ...
                items.push({
                    type: 'container',
                    html: "<span>Текущая страница <b>" + _page + "</b></span>"
                });
